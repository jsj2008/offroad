...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Mon May 16 20:32:48 2011
# Project:  app.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Offroad1.0.0/ && $(COPY_FILE) --parents App.h .tmp/Offroad1.0.0/ && $(COPY_FILE) --parents App.cpp btBulletWorldImporter.cpp BulletFileLoader/bChunk.cpp BulletFileLoader/bDNA.cpp BulletFileLoader/bFile.cpp BulletFileLoader/btBulletFile.cpp vehicle/btRaycastVehicle.cpp vehicle/btWheelInfo.cpp .tmp/Offroad1.0.0/ && (cd `dirname .tmp/Offroad1.0.0` && $(TAR) Offroad1.0.0.tar Offroad1.0.0 && $(COMPRESS) Offroad1.0.0.tar) && $(MOVE) `dirname .tmp/Offroad1.0.0`/Offroad1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Offroad1.0.0
